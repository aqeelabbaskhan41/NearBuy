    ...
    <header className="bg-slate-200 p-3 shadow-md mx-2 sm:mx-6  sticky top-0 z-50 mt-4">
      <div className="flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className="hidden md:flex gap-6 text-base font-medium">
          <li><NavLink to="/vendor/my-products" className={navLinkClasses}>My Products</NavLink></li>
          <li><NavLink to="/vendor/add-product" className={navLinkClasses}>Add Product</NavLink></li>
          <li><NavLink to="/vendor/about" className={navLinkClasses}>About</NavLink></li>
          <li><NavLink to="/vendor/contact" className={navLinkClasses}>Contact</NavLink></li>
        </ul>
      ...
      {isOpen && (
        <div className="md:hidden mt-4 space-y-3 flex flex-col items-start bg-white p-4 rounded-md shadow-inner max-w-7xl mx-auto">
          <NavLink to="/vendor/my-products" className={navLinkClasses}>My Products</NavLink>
          <NavLink to="/vendor/add-product" className={navLinkClasses}>Add Product</NavLink>
          <NavLink to="/vendor/about" className={navLinkClasses}>About</NavLink>
          <NavLink to="/vendor/contact" className={navLinkClasses}>Contact</NavLink>
          <button
