        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="xs:col-span-2 md:col-span-1 space-y-4">
            ...
            <p className="text-gray-600 text-sm sm:text-base">
              Empowering local vendors to grow their businesses with our marketplace.
            </p>
          ...
          <div className="mt-4 sm:mt-0">
            <h6 className="text-base sm:text-lg font-bold text-gray-900 uppercase tracking-wide mb-3 flex items-center">
              <FaBox className="mr-2 text-[#b88e2f] text-sm" /> Links
            </h6>
            <ul className="space-y-2.5">
              <li>
                <NavLink to="/vendor/my-products" className={navLinkClasses}>
                  <FaBox className="mr-2 text-xs" /> My Products
                </NavLink>
              </li>
              <li>
                <NavLink to="/vendor/add-product" className={navLinkClasses}>
                  <FaPlusCircle className="mr-2 text-xs" /> Add Product
                </NavLink>
              </li>
              <li>
                <NavLink to="/vendor/about" className={navLinkClasses}>
                  <FaInfoCircle className="mr-2 text-xs" /> About
                </NavLink>
              </li>
              <li>
                <NavLink to="/vendor/contact" className={navLinkClasses}>
          ...
          <div className="mt-4 sm:mt-0">
            <h6 className="text-base sm:text-lg font-bold text-gray-900 uppercase tracking-wide mb-3 flex items-center">
              <FaPhoneAlt className="mr-2 text-[#b88e2f] text-sm" /> Support
            </h6>
            <ul className="space-y-2.5">
              ...
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-600 text-sm sm:text-base">vendors@nearbuy.com</span>
              </li>
              <li className="flex items-start space-x-2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
              ...
              <div className="flex flex-wrap justify-center gap-3 sm:gap-4">
                ...
                <a href="#" className="text-gray-600 hover:text-[#b88e2f] text-xs sm:text-sm">Vendor Agreement</a>
